        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 p-5">
                    ...
                    <h4 data-aos="fade-up" data-aos-delay="100" class="mt-3 mb-5" style="color: white;">"Youth, Creative, and Innovative in
                        Future Technology"</h4>
                ...
                <div class="col-lg-6 col-sm-12 p-5" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="section-body">
                        <p style="text-align: justify; max-width: 600px;">
                            ...
                            Dengan diadakannya kegiatan Techcomfest, diharapkan siswa/i SMA/SMK sederajat dapat menyalurkan
            ...
            <div class="row g-4 text-center">
                <div class="col-lg-4 col-sm-6" data-aos="fade-down" data-aos-delay="150">
                    ...
                    <div class="border rounded theme-shadow p-lg-5 p-4 card-shadow">
                        ...
                        <img class="" src="assets/img/pie-chart.png" alt="" style="height: auto; width:50%;">
                        <h5 class="mt-4 mb-3">Infografis</h5>
                        <p>Lomba Infografis adalah salah satu jenis kompetisi desain grafis yang memberikan informasi dan desain ke dalam bentuk digital</p>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="bp">
                        <div class="bp-content pt-4 text-center">
                            ...
                            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p> -->
                            <a class="custom-link pt-3" href="/assets/file/RULEBOOK_WEB_DESIGN_TECHCOMFEST_2023.pdf" download>
                                <span>Unduh</span>
                                <i class="ri-download-2-line"></i>
                            </a>
                        </div>
                ...
                <div class="col-12 text-center " data-aos="fade-down" data-aos-delay="150">
                    ...
                    <div class="col d-flex justify-content-center" data-aos="fade-down" data-aos-delay="200">
                        <table class="table text-center" style="width: 70%;">
                            ...
                            <tbody>
                                <tr>
                                    <td>17 Oktober - 16 November 2023</td>
                                    <td>Pendaftaran Gelombang 1 Capture The Flag dan UI/UX Design</td>
                                </tr>
                                <tr>
                                    <td>17 Oktober - 16 Desember 2023</td>
                                    <td>Pendaftaran Web Design</td>
                                </tr>
                                <tr>
                                    <td>17 November - 16 Desember 2023</td>
                                    <td>Pendaftaran Gelombang 2 Capture The Flag dan UI/UX Design</td>
                                </tr>
                                <tr>
                                    <td>17 Oktober - 19 Desember 2023</td>
                                    <td>Pengerjaan dan Pengumpulan Karya UI/UX Design</td>
                                </tr>
                                <tr>
                                    <td>17 Oktober - 22 Desember 2023</td>
                                ...
                                <tr>
                                    ...
                                    <td>Babak Penyisihan UI/UX Design</td>
                                </tr>
                                <tr>
                                    <td>23 - 30 Desember 2023</td>
                                ...
                                <tr>
                                    ...
                                    <td>Pengumuman Finalis Capture The Flag, UI/UX Design, Web Design Competition</td>
                                </tr>
                                <tr>
                                    <td>3 - 10 Januari 2024</td>
                                    <td>Registrasi Ulang lomba Capture The Flag, UI/UX Design dan Web Design</td>
                                </tr>
                                <tr>
                                    <td>13 Januari 2024</td>
                                    <td>Technical Meeting lomba UI/UX Design, Web Design, Capture The Flag Competition</td>
                                </tr>
                                <tr>
                                    <td>20 Januari 2024</td>
                                    <td>Final UI/UX Design, Web Design, Capture The Flag Competition</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                            <div class="accordion-body">
                                Techcomfet ( Technology Computer Festival ) merupakan salah satu wujud misi dan peran aktif UKM Polytechnic Computer Club dalam mengikuti perkembangan teknologi dalam bidang IT melalui lomba SMA/ SMK sederajat dan   Mahasiswa Umum Se-Indonesia.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFive">
                            <div class="accordion-body">
                                Dalam Techcomfest 2023 terdapat 3 bidang yang diperlombakan yaitu Capture the Flag Competition, UI UX Design, dan Web Design Competition
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSeven">
                            <div class="accordion-body">
                                Instansi diperbolehkan mengirimkan lebih dari satu tim untuk setiap cabang lomba dengan syarat anggota tim tidak boleh ada yang sama
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseNine" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingNine">
                            <div class="accordion-body">
                                Untuk mata lomba Design Infografis dikenai biaya pendaftran sebesar Rp 60.000 per tim , Capture The Flag Competition sebesar Rp 85.000 per tim, dan untuk mata lomba Web Design tidak ada biaya pendaftaran
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseTen" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTen">
                            <div class="accordion-body">
                                Biaya pendaftaran ulang dikhususkan untuk mata lomba Web Design sebesar Rp 250.000 per tim. 
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="panelsStayOpen-headingEleven">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseEleven" aria-expanded="false" aria-controls="panelsStayOpen-collapseEleven">
                                Apakah untuk lomba bidang Design Infografis dapat mengirimkan karya yang pernah dilombakan di event lain?
                            </button>
                        </h2>
                        <div id="panelsStayOpen-collapseEleven" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingEleven">
                            <div class="accordion-body">
                                Karya yang dikirimkan adalah murni tidak pernah di perlombakan sebelumnya
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseThirteen" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThirteen">
                            <div class="accordion-body">
                                Untuk lomba Capture The Flag dilaksanakan secara online,  Namun untuk pemenang lomba diharapkan kehadirannya pada puncak acara yaitu Awarding night pada tanggal 21 Januari 2023 di Gedung Magister Terapan lantai 3 Politeknik Negeri Semarang
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="panelsStayOpen-headingFourteen">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFifteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseFifteen">
                                Apakah karya Design Infografis yang dikirim akan menjadi hak milik panitia?
                            </button>
                        </h2>
                        <div id="panelsStayOpen-collapseFifteen" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFourteen">
                            <div class="accordion-body">
                                Karya Design Infografis yang diperlombakan akan menjadi hak milik panitia
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row g-4 text-center">
                    <div class="col-12">
                        <p class="mb-0"><a href="#">Copyright 2022 - Polytechnic Computer Club - Politeknik Negeri Semarang</a></p>
                    </div>
                </div>
            </div>
        </div>
