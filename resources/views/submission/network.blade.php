...
<section class="section">
    <div class="section-header">
        <h1>Halaman Pengumpulan Lomba Capture The Flag</h1>
    ...
    <div class="section-body">
        ...
        <form method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data" autocomplete="off" action="{{ Route('SSNetwork') }}">
            @csrf
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="file" name="filerar" multiple required>
                                    </div>
                                </div>
