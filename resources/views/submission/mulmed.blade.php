                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Lembar Deskripsi (.pdf)</label>
                                    <div class="fallback">
                                        <input name="ldeskripsi" type="file" multiple required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Hasil Karya Lomba (.pdf / .png)</label>
                                    <div class="fallback">
                                        <input name="hasilkaryalomba" type="file" multiple required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Presentasi (.pdf / .ppt / .pptx)</label>
                                    <div class="fallback">
                                        <input name="presentasi" type="file" multiple required/>
                                    </div>
                                </div>
