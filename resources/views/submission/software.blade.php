...
<section class="section">
    <div class="section-header">
        <h1>Halaman Pengumpulan Lomba Web Design</h1>
                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Link Github (menggunakan <b> http atau https</b>)</label>
                                    <input type="url" name="linkdrive" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Link Hostingan (menggunakan <b> http atau https</b>)</label>
                                    <input type="url" name="linkhosting" class="form-control" required>
                                </div>
